...
function Waist() {
    ...
    const api = async () => {
        try {
            const data = await fetch('https://exercisedb.p.rapidapi.com/exercises?limit=10&offset=0', {
                headers: {
    ...
    return (<>
        <h1 style={{textAlign:'center', paddingTop:'20px'}}>Shape your waist</h1>
            ...
            <>
                ...
                <Card sx={{ maxWidth: 310 }}>
                    ...
                    <CardContent>
                        ...
                        <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                            The secondary Muscles that will be effect by 
                            doing this exercise are <h3 className={style.h}>{smuscles[1]}</h3> 
                        </Typography>
                    </CardContent>
                    <CardActions>
                ...
                <Card sx={{ maxWidth: 310 }}>
                    ...
                    <CardContent>
                        ...
                        <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                            The secondary Muscles that will be effect by 
                            doing this exercise are <h3 className={style.h}>{smuscles[2]}</h3> 
                        </Typography>
                    </CardContent>
                    <CardActions>
                        <Button size="small">Instructions</Button>
                ...
                <Card sx={{ maxWidth: 310 }}>
                    ...
                    <CardContent>
                        ...
                        <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                            The secondary Muscles that will be effect by 
                            doing this exercise are <h3 className={style.h}>{smuscles[3]}</h3> 
                        </Typography>
                    </CardContent>
                    <CardActions>
                        <Button size="small">Instructions</Button>
        ...
        <button id={style.head} onClick={()=>navigate('/fit')}>Home</button>
        <br/><br/>
        </>
    );
}
